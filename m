...
Received: from mm1.emwd.com (mm1.emwd.com [172.104.12.73])
	by mail.lfdr.de (Postfix) with ESMTPS id ADA4C5A3E4
	for <lists+devel-orangefs@lfdr.de>; Fri, 28 Jun 2019 20:36:01 +0200 (CEST)
Received: from [::1] (port=52756 helo=mm1.emwd.com)
	by mm1.emwd.com with esmtp (Exim 4.92)
	(envelope-from <devel-bounces@lists.orangefs.org>)
	id 1hgvj6-0007I8-Tr
	for lists+devel-orangefs@lfdr.de; Fri, 28 Jun 2019 14:36:00 -0400
Received: from userp2120.oracle.com ([156.151.31.85]:41370)
 by mm1.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256)
 (Exim 4.92) (envelope-from <darrick.wong@oracle.com>)
 id 1hgvj4-0007G3-TZ
 for devel@lists.orangefs.org; Fri, 28 Jun 2019 14:35:59 -0400
