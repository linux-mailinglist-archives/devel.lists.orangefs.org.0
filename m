...
Received: from mm1.emwd.com (mm1.emwd.com [172.104.12.73])
	by mail.lfdr.de (Postfix) with ESMTPS id 70BAD12DE9A
	for <lists+devel-orangefs@lfdr.de>; Wed,  1 Jan 2020 11:53:47 +0100 (CET)
Received: from [::1] (port=47422 helo=mm1.emwd.com)
	by mm1.emwd.com with esmtp (Exim 4.92)
	(envelope-from <devel-bounces@lists.orangefs.org>)
	id 1imbdK-0006Pz-Gk
	for lists+devel-orangefs@lfdr.de; Wed, 01 Jan 2020 05:53:46 -0500
Received: from mx0a-001b2d01.pphosted.com ([148.163.156.1]:7066)
 by mm1.emwd.com with esmtps (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256)
 (Exim 4.92) (envelope-from <riteshh@linux.ibm.com>)
 id 1imbdI-0006PL-AZ
 for devel@lists.orangefs.org; Wed, 01 Jan 2020 05:53:44 -0500
Received: from pps.filterd (m0098393.ppops.net [127.0.0.1])
 by mx0a-001b2d01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id
 001ApTle088652
 for <devel@lists.orangefs.org>; Wed, 1 Jan 2020 05:53:03 -0500
Received: from e06smtp04.uk.ibm.com (e06smtp04.uk.ibm.com [195.75.94.100])
 by mx0a-001b2d01.pphosted.com with ESMTP id 2x88je2qf7-1
 (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=NOT)
 for <devel@lists.orangefs.org>; Wed, 01 Jan 2020 05:53:03 -0500
...
Subject: [RESEND PATCH 1/1] fs: Use inode_lock/unlock class of provided APIs
 in filesystems
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0
 ...
 priorityscore=1501 suspectscore=3 phishscore=0 mlxlogscore=260
